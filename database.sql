...
--
-- Host: localhost:3306
-- Generation Time: Sep 19, 2024 at 10:44 PM
...
(61, 61, 'TONA', 'JAS', 'SMA', 'SMA', 'PETANI', 'PETANI');
...
--
ALTER TABLE `table_anak`
  MODIFY `id_anak` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=63;

--
-- AUTO_INCREMENT for table `table_kemampuan_anak`
--
ALTER TABLE `table_kemampuan_anak`
  MODIFY `id_kemampuan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=62;

--
-- AUTO_INCREMENT for table `table_orang_tua`
--
ALTER TABLE `table_orang_tua`
  MODIFY `id_orang_tua` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=63;
