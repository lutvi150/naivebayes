...
<head>
	...
	<meta content="keenthemes" name="<?= $this->config->item('owner') ?>">

	<meta property="og:site_name" content="<?= $this->config->item('app_name') ?>">
	<meta property="og:title" content="<?= $this->config->item('app_name') ?>">
	<meta property="og:description" content="oleh <?= $this->config->item('owner') ?>">
	<meta property="og:type" content="website">
	<meta property="og:image" content="<?= $this->config->item('app_name') ?>"><!-- link to image for socio -->
	<meta property="og:url" content="<?= $this->config->item('app_name') ?>">
...
<body class="hold-transition login-page">
	<div class="login-box">
		...
		<div class="login-box-body">
			...
			<form action="<?= base_url() ?>assets/index2.html" id="form-login" method="post">
